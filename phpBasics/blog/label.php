...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-8">
            <div class="card card-body bg-light"><p>You looked for <span class="badge badge-secondary">What is Technology ?</span></p></div>
            <div class="post">
                <a class="post-title h1" href="post.php">The first post</a>
                ...
                <p class="lead text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate
                    ...
                    quaerat recusandae reiciendis sint....<a class="small" href="post.php">Continue reading</a></p>
                <a href="#" class="badge badge-secondary">What is Technology ?</a>
                <a href="#" class="badge badge-secondary">How Technology works?</a>
                <a href="#" class="badge badge-secondary">Intro to the Technology</a>
            </div>
            <div class="post">
                <a class="post-title h1" href="post.php">The second post</a>
                <div class="meta small"><a href="#">06-05-2019</a> | <a href="#">Tachnology</a> | <a href="#">Mohamed
                        Amin HADRICH</a></div>
                <p class="lead text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate
                    deleniti laborum
            ...
            <div class="post">
                <a class="post-title h1" href="post.php">The third post</a>
                <div class="meta small"><a href="#">06-05-2019</a> | <a href="#">Tachnology</a> | <a href="#">Mohamed
                        Amin HADRICH</a></div>
                <p class="lead text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate
                    deleniti laborum
